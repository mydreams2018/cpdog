...
public interface ChannelInHandler<I,O> {
     ...
     *@Time 11:09
     */
    void before(SocketChannel socketChannel, ByteBuffer byteBuffer, I in) throws Exception;
     ...
     *@Time 11:09
     */
    O handler(SocketChannel socketChannel, ByteBuffer byteBuffer, I in) throws Exception;;
     ...
     *@Time 11:09
     */
    void after(SocketChannel socketChannel, ByteBuffer byteBuffer,I in);
    /*
    ...
    *@Time 11:09
    */
    void exception(Exception e,SocketChannel socketChannel, ByteBuffer byteBuffer,Object in) throws Exception;
    /*
