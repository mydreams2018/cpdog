...
public interface FilterInHandler {
     ...
     *@Date 2023/09/15
     */
    void init(WebSocketConvertData.WebSocketData webSocketData, SocketChannel socketChannel);
     ...
     *@Date 2023/09/15
     */
    boolean filter(WebSocketConvertData.WebSocketData webSocketData, SocketChannel socketChannel);
